...
def render_pdf(squares: list[Square], output: Path, labels: bool, alignment: str,
               page_width: float, page_height: float, margin: float) -> None:
    ...
    if squares:
        ...
        for square in squares:
            ...
            if labels and side >= 15:
                font_size = min(side * 0.45, side * 1.35 / len(str(square.size)),
