...
`demo-images/` contains tracked SVG, PNG, and PDF examples generated by this tool. Other generated image files remain ignored by Git, so you can experiment freely without adding temporary exports to version control.
